...
%% Rotation matrix
syms q11v q21v; %link angle
syms q11v_d q21v_d;
syms q11v_dd q21v_dd;

R0_1 = [cos(q11v),-sin(q11v),0;sin(q11v),cos(q11v),0;0,0,1];
R1_2 = [cos(q21v),-sin(q21v),0;sin(q21v),cos(q21v),0;0,0,1];
...
W0_0 = [0;0;0];
W1_1 = Wi1_i1(R1_0,W0_0,q11v_d,[0;0;1]);
W2_2 = Wi1_i1(R2_1,W1_1,q21v_d,[0;0;1]);
